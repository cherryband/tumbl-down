...
class TumblDownTestCase(unittest.TestCase):
    def test_extract_tumblr_image_links(self):
        ...
        self.assertEqual(extractor.extract_tumblr_images("https://zandraart.tumblr.com/post/662604327475707904/jellies"),
        ...
        self.assertEqual(extractor.extract_tumblr_images("https://maruti-bitamin.tumblr.com/post/663149423546777600/sun-sea"),
        ...
        self.assertEqual(extractor.extract_tumblr_images("https://stuckwith-harry.tumblr.com/post/640948223894290432/lesser-movies-than-mamma-mia-2008-wouldve-made"),
                        [])
